...
| Vidu | q3-pro / q2 / q2-pro / q2-turbo | q3-pro | ✓ | q2-pro / q2-turbo | q2 支持多图（≤7 张） |
...
| 模型 | 版本 | 分辨率 | 最大参考图 | 支持宽高比 |
|------|------|--------|-----------|-----------|
| GEM (Gemini) | 2.5 (nano banana) | 1K / 2K / 4K | 3 张 | 10 种比例 |
| GEM (Gemini) | 3.0 (nano banana pro) | 1K / 2K / 4K | 3 张 | 10 种比例 |
| GEM (Gemini) | 3.1 (nano banana2) | — | 3 张 | 10 种比例 |
| Qwen (千问) | 0925 | — | 1 张 | 不支持 |
| Seedream (豆包) | 4.5 | — | 1 张 | 7 种比例 |
| Kling (可灵) | 2.1 | 1K / 2K | 1 张 | 8 种比例 |
| Vidu | q2 | 1080P / 2K / 4K | 7 张 | 8 种比例 |
| Jimeng (即梦) | 4.0 | — | 1 张 | 7 种比例 |
| Hunyuan (混元) | 3.0 | 720P / 1080P / 2K / 4K | 1 张 | 8 种比例 |

### 图片生成 FileInfos 规则

- 参考图为可选项，不传则纯文生图
- GEM 3.x 和 Vidu q2 支持多张参考图（webp 格式额外支持）
